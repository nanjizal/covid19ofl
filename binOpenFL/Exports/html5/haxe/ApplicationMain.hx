...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("covid19ofl", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("covid19ofl", null, 1024, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "covid19ofl";
		app.meta["name"] = "covid19ofl";
		app.meta["packageName"] = "net.nanjizal.covid19ofl";
		...
		#elseif !air
		app.window.context.attributes.background = 1579032;
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("covid19.Covid19ofl")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess covid19.Covid19ofl.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"covid19.Covid19ofl\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"covid19.Covid19ofl\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends covid19.Covid19ofl {}
#else
class DocumentClass
{
